...
await sharp({create:{width:512,height:512,channels:4,background:'#252823'}}).composite([{input:await sharp(svg).resize(340).png().toBuffer(),gravity:'centre'}]).png().toFile('dist/icons/maskable-512.png');

export const defaultPreferences = Object.freeze({theme:'system',focus:false,reveal:'word',wordSpeed:180,charSpeed:18,textSize:1,narration:false,music:false,musicVolume:18,savedLayout:'grid',videoControls:'minimal',videoMuted:true,voiceURI:'',speechRate:1});
export function normalizePreferences(raw={}) {
 ...
 return {theme:pick('theme',['system','light','dark']),focus:typeof p.focus==='boolean'?p.focus:false,reveal:pick('reveal',['word','char']),wordSpeed:number('wordSpeed',60,360),charSpeed:number('charSpeed',5,40),textSize:number('textSize',.9,1.2),narration:typeof p.narration==='boolean'?p.narration:false,music:typeof p.music==='boolean'?p.music:false,musicVolume:number('musicVolume',0,40),savedLayout:pick('savedLayout',['grid','list']),videoControls:pick('videoControls',['minimal','native']),videoMuted:typeof p.videoMuted==='boolean'?p.videoMuted:true,voiceURI:typeof p.voiceURI==='string'&&p.voiceURI.length<=300?p.voiceURI:'',speechRate:number('speechRate',.7,1.3)};
}

export const defaultPreferences = Object.freeze({theme:'system',focus:false,reveal:'word',wordSpeed:180,charSpeed:18,textSize:1,narration:false,music:false,musicVolume:18,savedLayout:'grid',videoControls:'native',videoMuted:true,videoVolume:100,voiceURI:'',speechRate:1});

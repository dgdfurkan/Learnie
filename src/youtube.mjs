...
export function youtubeOptions(origin=''){
 // Start once through loadVideoById after readiness. YouTube owns all media
 // controls; there is no second Learnie play/seek/volume control bar.
 return {autoplay:0,playsinline:1,hl:'tr',rel:0,cc_lang_pref:'tr',cc_load_policy:1,iv_load_policy:3,color:'white',controls:1,origin};
}
